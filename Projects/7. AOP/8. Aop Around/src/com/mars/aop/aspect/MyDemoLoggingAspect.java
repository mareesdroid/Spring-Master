...
public class MyDemoLoggingAspect {	
	...
	public Object aroundGetTraffic(ProceedingJoinPoint theProceedingJoinPoint) throws Throwable{
		...
		System.out.println("------>>>>>.AOP DEBUGGING LOGS BEGIN:");
		...
		System.out.println("Method runs completed time = " + processDuration / 1000 + " seconds");
		System.out.println("------>>>>>.AOP DEBUGGING LOGS ENDS");
		return result;
	}
